...
const Add = () => {
  ...
  return (
    <AppLayout title="Zaiko - Agregar Usuarios">
              ...
              <div className="w-full p-4 px-5 py-2">
                <div className="sm:grid md:grid-cols-2 lg:grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 sm:col-span-2 md:col-span-2 flex justify-end items-center gap-4">
                    <button type="submit" className="btn-xs text-white bg-successHard hover:bg-success px-5 py-2">
                      Guardar
                    </button>
                    <button type="reset" className="btn-xs text-white bg-secondaryHard hover:bg-secondary px-5 py-2">
                      Limpiar
                    </button>
                  </div>
                </div>
