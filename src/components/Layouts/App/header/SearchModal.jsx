...
export const SearchModal = ({ id, searchId, modalOpen, setModalOpen }) => {
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link className="flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group" href="#" onClick={() => setModalOpen(!modalOpen)}>
