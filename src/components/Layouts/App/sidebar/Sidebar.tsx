                    ...
                    return (
                      <SidebarLinkGroup key={item.name} activecondition={path.includes(item.pathname)}>
                        {(handleClick, open) => {
                          return (
                            <>
                              <SidebarMenuIndividual key={item.name} pathname={item.pathname} name={item.name} url={item.url} icon={item.icon} numberNotification={2} open={open} />
                            </>
                          );
                        }}
                      </SidebarLinkGroup>
                    ...
                    return (
                      <SidebarLinkGroup key={item.name} activecondition={path.includes(item.pathname)}>
                        {(handleClick, open) => {
                          return (
                            <>
                              <SidebarMenu menuItems={item} handleClick={handleClick} open={open} />
                            </>
                          );
                        }}
                      </SidebarLinkGroup>
